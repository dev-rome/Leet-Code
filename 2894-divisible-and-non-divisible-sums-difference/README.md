...
<pre style="position: relative;"><strong>Input:</strong> n = 10, m = 3
...
<pre style="position: relative;"><strong>Input:</strong> n = 5, m = 6
...
<pre style="position: relative;"><strong>Input:</strong> n = 5, m = 1
<strong>Output:</strong> -15
<strong>Explanation:</strong> In the given example:
